...
class RemoveExpiredCartsCommand extends Command
{
     ...
     */
    public function __construct(EntityManagerInterface $entityManager, CommandesRepository $commandesRepository)
    {
        parent::__construct();
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        while($carts = $this->commandesRepository->findCartsNotModifiedSince($limitDate)) {
