...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('form.post_submit', [0 => function () {
            return ($this->privates['App\\Form\\EventListener\\RemoveCartItem'] ?? ($this->privates['App\\Form\\EventListener\\RemoveCartItem'] = new \App\Form\EventListener\RemoveCartItem()));
        }, 1 => 'postSubmit'], 0);
        $instance->addListener('kernel.response', [0 => function () {
